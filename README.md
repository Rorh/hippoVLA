# StarVLA Environment Setup and CALVIN Evaluation
...
- `starVLA`: starts the StarVLA policy server.
...
export EVAL_SEQUENCES_PATH=/home/rorschach/github_projects/vla/starVLA_code/examples/calvin/eval_files/eval_sequences.json
```
